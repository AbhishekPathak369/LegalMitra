...
const testLawyerAPI = async () => {
  try {
    ...
    const response = await fetch('http://localhost:5000/api/lawyer/verification-status', {
      method: 'GET',
      headers: {
...
const requestVerification = async () => {
  try {
    ...
    const response = await fetch('http://localhost:5000/api/lawyer/request-verification', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
  ...
  const submitClientCaseAfterPayment = async (caseData, paymentId, razorpayOrderId) => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/cases/client/create-after-payment', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
          ...
          <div className="features-grid">
            ...
            <div className="feature-item">
              ...
              <div className="feature-text">
                ...
                <p>Connect with other legal experts</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="pricing-options-grid">
            ...
            <div className={`pricing-option ${!hasPaid ? 'recommended' : ''}`}>
              ...
              <ul className="option-features">
                ...
                <li>✅ Featured in lawyer directory</li>
                <li>✅ Priority client referrals</li>
              </ul>
